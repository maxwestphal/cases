...
in several subgroups (strata). The package implements different methods for multiplicity adjustment
for that purpose (e.g. Bonferonni, maxT, pairs bootstrap).
For instance, it allows to asses the accuracy of multiple candidate (index) diagnostic tests which is often measured with the two co-primary endpoints 
